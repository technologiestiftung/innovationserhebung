...
def create_app():
    ...
    pie_plotter = plotter_factory.create_plotter("pie")
    pie_plotter.fit_data(pie_data)
    pie_plotter.create_plot()

    pie_plotter_2 = plotter_factory.create_plotter("pie")
    pie_plotter_2.fit_data(pie_data)
    pie_plotter_2.create_plot()

    bubble_plotter = plotter_factory.create_plotter("bubble")
    bubble_plotter.fit_data(bubble_data)
    bubble_plotter.create_plot()

    line_plotter = plotter_factory.create_plotter("line")
    line_plotter.fit_data(line_data)
    line_plotter.create_plot()

    bar_plotter = plotter_factory.create_plotter("bar")
    bar_plotter.fit_data(bar_data)
    ...
    gspec[2:3, 0:2] = line_plotter.plot
    gspec[3:4, 0:2] = bar_plotter.plot
